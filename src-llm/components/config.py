GPT_CONFIG_124M = {
    ...
    "batch_size": 12,  # batch size (gpt 12)
    "ctx_len": 32,  # context length (default 1024)
    "emb_dim": 32,  # embedding dimesension (default 768)
    "n_head": 8,  # number of attention heads (default 12)
    "n_layers": 8,  # number of layers (default 12)
